<template>
  ...
  <div class="w-1/2 md:w-1/3 lg:w-64 fixed md:top-0 md:left-0 h-screen lg:block bg-gray-100 border-r z-30 overflow-scroll"
       :class="sideBarOpen ? '' : 'hidden'" id="main-nav">

    <div class="w-full h-20 border-b flex px-4 items-center mb-8">
      <p class="font-semibold text-3xl text-blue-400 pl-4">#TeamTees</p>
    </div>
    ...
    <div class="mb-4 px-4">
      ...
      <router-link :to="{ name: 'TestOrders' }">
      <div class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer">
        ...
        <span class="text-gray-700">Test Orders</span>
      </div>
      </router-link>
    ...
    <div class="mb-4 px-4" v-if="hasRole('Designer') === true">
      ...
      <div class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer">
        ...
        <span class="text-gray-700">Work In Progress</span>
      </div>
      </router-link>
      ...
      <div class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer">
        ...
        <span class="text-gray-700">Completed Requests</span>
      </div>
      </router-link>
    </div>

    <div class="mb-4 px-4" v-if="hasRole('Designer') === true">
      <p class="pl-4 text-sm font-semibold mb-1">DYO</p>
      ...
      <router-link :to="{ name: 'DyoOrders', params: {status:1} }">
      <div
          class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer">
        <svg class="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
          <path
      ...
      <router-link :to="{ name: 'DyoOrders', params: {status:2} }">
      <div
          class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer">
        <svg class="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
          <path
        ...
        <span class="text-gray-700">Processing Orders</span>
      </div>
      </router-link>

      <router-link :to="{ name: 'DyoOrders', params: {status:4} }">
      <div
          class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer">
        <svg class="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
          <path
        ...
        <span class="text-gray-700">Verified Orders</span>
      </div>
      </router-link>

    </div>

    <div class="mb-4 px-4" v-if="hasRole('Factory') === true">
      <p class="pl-4 text-sm font-semibold mb-1">Factory Orders</p>

      <router-link :to="{ name: 'FactoryDashboard' }">
        <div
            class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer">
          <svg class="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
            <path
      ...
      <router-link :to="{ name: 'FactoryOrders', params: {status:'new'} }">
        <div
            class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer">
          <svg class="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
            <path
      ...
      <router-link :to="{ name: 'FactoryOrders', params: {status:'processing'} }">
        <div
            class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer">
          <svg class="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
            <path
      ...
      <router-link :to="{ name: 'FactoryOrders', params: {status:'in-warehouse'} }">
        <div
          ...
          <span class="text-gray-700">In Warehouse</span>
        </div>
      </router-link>

    </div>

    <div class="mb-4 px-4" v-if="hasRole('Warehouse') === true">
      <p class="pl-4 text-sm font-semibold mb-1">Warehouse Orders</p>

      <router-link :to="{ name: 'WarehouseDashboard' }">
        <div
            class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer">
          <svg class="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
            <path
      ...
      <router-link :to="{ name: 'WarehouseOrders', params: {status:'new'} }">
        <div
            class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer">
          <svg class="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
            <path
      ...
      <router-link :to="{ name: 'WarehouseOrders', params: {status:'processing'} }">
        <div
            class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer">
          <svg class="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
            <path
      ...
      <router-link :to="{ name: 'WarehouseOrders', params: {status:'shipped'} }">
        <div
            class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer">
          <svg class="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
            <path
          ...
          <span class="text-gray-700">Shipped Orders</span>
        </div>
      </router-link>

      <router-link :to="{ name: 'WarehouseOrders', params: {status:'ready_to_pickup'} }">
        <div
            class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer">
          <svg class="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
            <path
          ...
          <span class="text-gray-700">Ready To Pick Up</span>
        </div>
      </router-link>

      <router-link :to="{ name: 'WarehouseOrders', params: {status:'completed'} }">
        <div
            class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer">
          <svg class="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
            <path
...
export default {
  ...
  methods: {
    hasRole(roleName) {
      if (this.userRoles.indexOf("Administrator") >= 0) {
        return true;
      }

      if (this.userRoles.indexOf(roleName) >= 0) {
        return true;
      }
    }
  },
  computed: {
    ...mapState('sideBar', ['sideBarOpen'])
  },
  mounted() {
