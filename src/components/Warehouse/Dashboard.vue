        ...
        <div class="w-full bg-white border text-blue-400 rounded-lg flex items-center pr-2 pl-2 pb-6 pt-6 mb-6 xl:mb-0">
          ...
          <div class="text-gray-700">
            <p class="font-semibold text-2xl">New Orders : {{ warehouseDashboardData.new }}
              <el-link v-on:click="handleViewClick('new')" icon="el-icon-link">View Orders</el-link>
            </p>
        ...
        <div class="w-full bg-white border text-blue-400 rounded-lg flex items-center pr-2 pl-2 pb-6 pt-6 mb-6 xl:mb-0">
          ...
          <div class="text-gray-700">
            <p class="font-semibold text-2xl">Processing : {{ warehouseDashboardData.processing }}
              <el-link v-on:click="handleViewClick('processing')" icon="el-icon-link">View Orders</el-link>
            </p>
        ...
        <div class="w-full bg-white border text-blue-400 rounded-lg flex items-center pr-2 pl-2 pb-6 pt-6 mb-6 xl:mb-0">
          ...
          <div class="text-gray-700">
            <p class="font-semibold text-2xl">Shipped : {{ warehouseDashboardData.shipped }}
              <el-link v-on:click="handleViewClick('shipped')" icon="el-icon-link">View Orders</el-link>
            </p>
        ...
        <div class="w-full bg-white border text-blue-400 rounded-lg flex items-center pr-2 pl-2 pb-6 pt-6 mb-6 xl:mb-0">
          ...
          <div class="text-gray-700">
            <p class="font-semibold text-2xl">Ready To Pickup : {{ warehouseDashboardData.ready_to_pickup }}
              <el-link v-on:click="handleViewClick('ready_to_pickup')" icon="el-icon-link">View Orders</el-link>
            </p>
...
export default {
  ...
  methods: {
    ...mapActions('dashboardData', ['fetchWarehouseDashboardData']),
    handleViewClick(status) {
      return this.$router.push({ name: "WarehouseOrders", params: {status: status}});
    },
  },
  computed: {
    ...mapState('dashboardData', ['warehouseDashboardData']),
  },
  created() {
